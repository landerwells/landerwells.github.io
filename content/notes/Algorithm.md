...
Algorithm: a finite set of rules that gives a sequence of operations for solving
...
5.  An algorithm is generally expected to be effective.
    Could be done using pencil and paper
